...
namespace Seldon
{
  ...
  */
  ...
  MatrixCollection<T, Prop, Storage, Allocator>::MatrixCollection():
  ...
  */
  template <class T, class Prop, class Storage, class Allocator>
  void MatrixCollection<T, Prop, Storage, Allocator>::Clear()
  {
  ...
  */
  template <class T, class Prop, class Storage, class Allocator>
  void MatrixCollection<T, Prop, Storage, Allocator>::Nullify()
  {
    for (int i = 0; i < Mmatrix_; i++)
      for (int j = 0; j < Nmatrix_; j++)
	matrix_(i, j).Nullify();
  ...
  */
  ...
  template <class T, class Prop, class Storage, class Allocator>
  void MatrixCollection<T, Prop, Storage, Allocator>::Deallocate()
  {
    for (int i = 0; i < Mmatrix_; i++)
      for (int j = 0; j < Nmatrix_; j++)
	GetMatrix(i, j).Clear();
  ...
  */
  template <class T, class Prop, class Storage, class Allocator>
  typename MatrixCollection<T, Prop, Storage, Allocator>
  ::value_type
