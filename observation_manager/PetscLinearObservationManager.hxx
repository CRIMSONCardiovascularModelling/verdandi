...
#ifndef VERDANDI_FILE_OBSERVATION_MANAGER_PETSCLINEAROBSERVATIONMANAGER_HXX
...
namespace Verdandi
{
    ...
    */
    template <class T>
    class PetscLinearObservationManager: public VerdandiBase
    {
...
#define VERDANDI_FILE_OBSERVATION_MANAGER_PETSCLINEAROBSERVATIONMANAGER_HXX
#endif
